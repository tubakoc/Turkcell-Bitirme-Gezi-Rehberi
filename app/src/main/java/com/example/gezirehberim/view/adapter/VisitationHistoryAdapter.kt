...
class VisitationHistoryAdapter(var list: ArrayList<Visitation>) :
    RecyclerView.Adapter<VisitationHistoryViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VisitationHistoryViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.description_layout, parent, false)
