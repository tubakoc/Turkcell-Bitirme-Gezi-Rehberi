...
class PlacePhotoAdapter (val context: Context, var liste:ArrayList<Place>, val itemClick : (position : Int)->Unit, var deletePhotoClick : (position : Int) -> Unit,  var addPhotoClick : (position : Int) -> Unit) : RecyclerView.Adapter<PlacePhotoViewHolder>() {
