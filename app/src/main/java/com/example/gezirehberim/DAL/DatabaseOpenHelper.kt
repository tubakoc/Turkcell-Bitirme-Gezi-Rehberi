...
class DatabaseOpenHelper(
    ...
    override fun onCreate(p0: SQLiteDatabase) {
        var query =
            "CREATE TABLE Place(Id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, Name TEXT,LocationDefinition TEXT,Description TEXT,Priority TEXT,Latitude REAL NOT NULL,Longitude REAL NOT NULL,IsVisited INTEGER NOT NULL) "
        p0.execSQL(query)
        query =
